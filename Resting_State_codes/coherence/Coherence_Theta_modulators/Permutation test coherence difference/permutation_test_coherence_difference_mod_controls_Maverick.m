...
name_modulators = '/coh_spec_m_fk_200_W_5.mat';
name_SA = '/coh_spec_m_Controls_same_area_fk_200_W_5.mat'; % -- name file to load 
name_OA = '/coh_spec_m_Controls_other_areas_fk_200_W_5.mat'; % -- name file to load 
...
dir_input = strcat(dir_RS_Theta,'/Modulators_Controls_avg_results/last_recording');
