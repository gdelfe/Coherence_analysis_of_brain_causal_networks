...
fk = 200; W = 5;
load(strcat(dir_RS,sprintf('/coh_spec_m_Controls_other_areas_fk_%d_W_%d.mat',fk,W)))
load(strcat(dir_RS,sprintf('/coh_spec_sr_Controls_other_areas_fk_%d_W_%d.mat',fk,W)))
