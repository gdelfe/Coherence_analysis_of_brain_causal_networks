...
load(strcat(dir_high_low_theta,'/coh_all_sess_controls_OA.mat'))
...
title('Coherence MR high vs low theta power trial: modulators vs controls SReg/OReg','FontSize',10)
...
fname = strcat(dir_high_low_theta,'/MR_mod_vs_controls_coherence_mean.jpg');
saveas(fig,fname);
