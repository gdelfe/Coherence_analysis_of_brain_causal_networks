...
save(strcat(dir_high_low_theta,'/coh_all_sess_controls_SA_high-low_pow_controls.mat'),'ctrl_coh')
...
title('SA: Coherence MR high vs low theta power trial of the controls','FontSize',12)
...
fname = strcat(dir_high_low_theta,'/MR_controls_SA_coherence_mean_high-low_pow_controls.jpg');
saveas(fig,fname);
...
xlabel('Frequency (Hz)','FontName','Arial','FontSize',15);
ylabel('Coherence','FontName','Arial','FontSize',15);
title('SA: Coherence MS high vs low theta power trial of the controls','FontSize',12)
legend('high theta pow','low theta pow','FontSize',10,'FontName','Arial')
set(gcf, 'Position',  [100, 600, 898, 500])
xlim([1 95])
% ylim([0 0.36])
...
fname = strcat(dir_high_low_theta,'/MS_controls_SA_coherence_mean_high-low_pow_controls.jpg');
saveas(fig,fname);
