...
sess_info = textscan(fid,'%d%s%s'); % sess label, date, recording number
fclose(fid);
...
for s = 1:size(sess_info{1},1)  % For each session with at least one modulator
    ...
    coh_all_mod_ms_high = zeros(n_mod,409); % 409 is the number of frequency values
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Code ends here, the rest is for plotting and quick visualization of some of the figures
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
