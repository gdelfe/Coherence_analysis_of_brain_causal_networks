...
% for those trials having high/low modulator theta power, for the
% modulators ranked according to the AUC
%
%
...
% %%%%%%%%%%%%%%%%%
% The code ends here, the rest is for quick plotting and visualization of
% some of the results
% %%%%%%%%%%%%%%%%%%%
