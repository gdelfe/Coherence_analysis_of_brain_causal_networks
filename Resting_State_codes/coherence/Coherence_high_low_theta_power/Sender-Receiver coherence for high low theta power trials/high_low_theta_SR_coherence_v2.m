...
name_output = '/send_rec_coh_for_session_v2.mat';
...
%         saveas(fig_coh,fname);
    ...
    save(strcat(dir_Sess_send_rec_data,name_output),'send_rec');
...
save(strcat(dir_high_low_theta,'/coh_all_sess_sr_high_v2.mat'),'coh_all_c_sr_high')
save(strcat(dir_high_low_theta,'/coh_all_sess_sr_low_v2.mat'),'coh_all_c_sr_low')
...
fname = strcat(dir_high_low_theta,sprintf('/SR_all_coherence_mean_v2.jpg',cnt_m));
saveas(fig,fname);
