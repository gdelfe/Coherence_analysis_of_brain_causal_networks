...
% coherence for high and low electrode power trials, where electrodes are
% in the same area as the modulators. The final test
% statistic is the coherence difference( high - low)
%
...
save(strcat(dir_high_low_theta,'/coh_diff_perm_ctlr_SA_mav.mat'),'diff','-v7.3')
