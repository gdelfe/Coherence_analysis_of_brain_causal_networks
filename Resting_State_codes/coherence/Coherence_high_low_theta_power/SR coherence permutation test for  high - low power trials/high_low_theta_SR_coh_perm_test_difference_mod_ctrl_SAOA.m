...
save(strcat(dir_perm,'/coh_diff_modulators_high_low_mod_SA_mav_v2.mat'),'diff_mod_SA','-v7.3')
save(strcat(dir_perm,'/coh_diff_ctlr_SA_high_low_mod_SA_mav_v2.mat'),'diff_ctrl_SA','-v7.3')
save(strcat(dir_perm,'/coh_diff_of_diff_mod_ctrl_SA_mav_v2.mat'),'diff_mod_ctrl_SA','-v7.3')


save(strcat(dir_perm,'/coh_diff_modulators_high_low_mod_OA_mav_v2.mat'),'diff_mod_OA','-v7.3')
save(strcat(dir_perm,'/coh_diff_ctlr_SA_high_low_mod_OA_mav_v2.mat'),'diff_ctrl_OA','-v7.3')
save(strcat(dir_perm,'/coh_diff_of_diff_mod_ctrl_OA_mav_v2.mat'),'diff_mod_ctrl_OA','-v7.3')

save(strcat(dir_perm,'/coh_diff_ctrl_SAOA_high_low_mav_v2.mat'),'diff_ctrl_SAOA','-v7.3')
save(strcat(dir_perm,'/coh_diff_ctrl_OASA_high_low_mav_v2.mat'),'diff_ctrl_OASA','-v7.3')
save(strcat(dir_perm,'/coh_diff_of_diff_ctrl_SAOA_mav_v2.mat'),'diff_diff_ctrl','-v7.3')
