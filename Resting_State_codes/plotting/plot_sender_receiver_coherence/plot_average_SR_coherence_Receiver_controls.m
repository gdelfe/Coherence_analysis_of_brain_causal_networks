...
fname = strcat(dir_RS,sprintf('/coherency_SR_Sender_vs_Receiver_ctrl_W_%d_fk_%d.png',W,fk));
saveas(fig,fname)
fname = strcat(dir_RS,sprintf('/coherency_SR_Sender_vs_Receiver_ctrl_W_%d_fk_%d.fig',W,fk));
saveas(fig,fname)
