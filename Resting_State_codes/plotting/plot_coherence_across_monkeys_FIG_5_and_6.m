% This code computes the average Sender-Modulator and Receiver-Modulator 
% coherence across monkeys. Furtheremore, it computes the average
% sender-control and receiver-control coherence for controls in the
% modulator region and in all other regions.
%
% Results are used to generate the plots in Fig. 5A and 6A of the paper
% (1st submission)
%
% @ Gino Del Ferraro, Pesaran Lab, NYU
