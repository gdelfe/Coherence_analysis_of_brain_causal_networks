...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       MAVERICK              %
mod_list = importdata(strcat(dir_ctrl_Maverick,'/modulators_sorted_decod_accuracy.txt'));
...
sess_numb_M = unique(mod_list(1:N,1));
...
% %%%%%%%%% MODULATORS Maverick %%%%%%
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_m_fk_%d_W_%d%s',fk,W,namefile))); % structure mod
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_sr_fk_%d_W_%d%s',fk,W,namefile))); % structure stim
struct_mod_mav = mod;
...
% -- select the first N index
mod_idx = mod_list(1:N,4);
sess_numb_A = unique(mod_list(1:N,1));
...
% %%%%%%%%% MODULATORS Archie %%%%%%
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_m_fk_%d_W_%d%s',fk,W,namefile))); % structure mod
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_sr_fk_%d_W_%d%s',fk,W,namefile))); % structure stim
struct_mod_arc = mod;
...
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_m_Controls_same_area_fk_%d_W_%d%s',fk,W,namefile)));
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_sr_Controls_same_area_fk_%d_W_%d%s',fk,W,namefile)));
mod_ctrl_SA_mav = mod;
stim_ctrl_SA_mav = stim;

ctrl_list = importdata(strcat(dir_ctrl_Maverick,'/control_list_same_area.txt'));
...
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_m_Controls_same_area_fk_%d_W_%d%s',fk,W,namefile)));
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_sr_Controls_same_area_fk_%d_W_%d%s',fk,W,namefile)));
mod_ctrl_SA_arc = mod;
stim_ctrl_SA_arc = stim;

ctrl_list = importdata(strcat(dir_ctrl_Archie,'/control_list_same_area.txt'));
...
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_m_Controls_other_areas_fk_%d_W_%d%s',fk,W,namefile)));
load(strcat(dir_avg_coh_Maverick,sprintf('/coh_spec_sr_Controls_other_areas_fk_%d_W_%d%s',fk,W,namefile)));
mod_ctrl_OA_mav = mod;
stim_ctrl_OA_mav = stim;

ctrl_list = importdata(strcat(dir_ctrl_Maverick,'/control_list_other_areas.txt'));
...
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_m_Controls_other_areas_fk_%d_W_%d%s',fk,W,namefile)));
load(strcat(dir_avg_coh_Archie,sprintf('/coh_spec_sr_Controls_other_areas_fk_%d_W_%d%s',fk,W,namefile)));
mod_ctrl_OA_arc = mod;
stim_ctrl_OA_arc = stim;

ctrl_list = importdata(strcat(dir_ctrl_Archie,'/control_list_other_areas.txt'));
