...
% --- Error bars
err_ms_MA = std_cho_ms_MA/48;
err_mr_MA = std_cho_mr_MA/48;
err_sr_MA = std_cho_sr_MA/20;

err_ms_AM = std_cho_ms_AM/48;
err_mr_AM = std_cho_mr_AM/48;
err_sr_AM = std_cho_sr_AM/20;
...
errorbar(f,mean_cho_mr_MA,err_mr_MA); hold on
errorbar(f,mean_cho_sr_MA,err_sr_MA); hold on
