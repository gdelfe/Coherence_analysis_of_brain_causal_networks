...
name_output = 'session_controls_same_area_lfp.mat'
name_structure_data_info = '/session_controls_same_area_info.mat'; % name input 
...
%     saveas(fig,fname)
    ...
    save(strcat(dir_Sess,name_output),'sess_control_lfp');
