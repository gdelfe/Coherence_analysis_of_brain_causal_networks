...
%     saveas(fig,fname)
    ...
    ctrl_Ch = sess_control.ctrl_idx; % -- controls for sender: all other areas 
    cnt_M = 1;
    for Ch = ctrl_Ch  % -- sender controls 
    ...
    % -- outliers for the control electrodes 
    ...
    % -- sender controls "all other areas" outliers
    cnt_m = 1;
    for Ch = ctrl_Ch % -- % -- controls for sender: all other areas 
