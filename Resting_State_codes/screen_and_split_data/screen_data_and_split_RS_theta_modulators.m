...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code loads the entire RS time series for the THETA MODULATORS and check for artifacts in the lfp 
...
%     saveas(fig,fname)
    ...
    sess_data_lfp
    dir_RS_Theta_Sess  = strcat(dir_RS_Theta,sprintf('/Sess_%d',Sess));
    save(strcat(dir_RS_Theta_Sess,'/session_data_lfp.mat'),'sess_data_lfp');
