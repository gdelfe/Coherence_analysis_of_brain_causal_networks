...
main_dir = '/mnt/pesaranlab/People/Gino/Coherence_modulator_analysis/Shaoyu_data'
dir_Stim = strcat(main_dir,'/Archie/Stim_data');
...
%         
        ...
        AnalParams.TestSpecDiff.fk = f_range; 
