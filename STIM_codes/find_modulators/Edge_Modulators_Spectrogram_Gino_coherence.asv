...
% addpath('U:\Maverick_RecStim_vSUBNETS220/')
addpath('/mnt/pesaranlab/Matlab/monkeys/')
addpath('/mnt/pesaranlab/Matlab/')
addpath('/mnt/raid/analyze/')
addpath('/mnt/raid/')
addpath('/vol/bd3/NYUMC_CorticalStim/matlab/mfiles/Shaoyu/')
addpath('/vol/bd4/Maverick_RecStim_vSUBNETS220/matlab/mfiles/Shaoyu/')
...
%                             title(['Modulator e' num2str(chs_FreqBand(indx))])
                            ...
                            [auc,se,S1,S2,roc_Thresh,maxYoudenIndex] = calcRocSpecDiff_git(X1,X2,AnalParams);
