...
dir_Perm = '/mnt/pesaranlab/People/Gino/Coherence_modulator_analysis/Shaoyu_data/STIM_coders/Permutation_test';
...
% %%%%%%%%% PERMUTED DATA  %%%%%%
load(strcat(dir_Perm,sprintf('/coh_spec_mr_permuted_fk_%d_W_%d.mat',fk,W))); % structure stim perm
