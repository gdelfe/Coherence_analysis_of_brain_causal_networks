...
function homogeneous_proj(data,hitIndx,missIndx,tapers,fs,dn,fk,pad,iSubject,iSess,iCh)
...
Dir_dataHits = sprintf('Ryan_data/Data/Hits/%d_Subject/%d_Sess/%d_Ch/all_pulses_N_15_W_25_k_2_dn_018',iSubject,iSess,iCh)
...
Dir_dataMisses = sprintf('Ryan_data/Data/Misses/%d_Subject/%d_Sess/%d_Ch/all_pulses_N_15_W_25_k_2_dn_018',iSubject,iSess,iCh)
